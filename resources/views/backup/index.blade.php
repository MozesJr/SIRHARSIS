                                                ...
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th class="sorting" tabindex="0" aria-controls="simpletable"
                                                            rowspan="1" colspan="1"
                                                            aria-label="Kondisi Backup: activate to sort column ascending">
                                                            Kondisi Backup</th>
                                                        <th class="sorting" tabindex="0" aria-controls="simpletable"
                                                            rowspan="1" colspan="1"
                                                                    ...
                                                                    <div class="modal-dialog">
                                                                        <div class="modal-content">
                                                                            ...
                                                                            <div class="modal-body">
                                                                                <div class="col-md-12">
                                                                                    <form method="POST"
                                                                                        action="{{ route('backup.update', $data->id) }}">
                                                                                        @csrf
                                                                                        @method('PUT')
                ...
                <div class="modal-body">
                    <div class="col-md-12">
                        <form method="POST" action="{{ route('backup.store') }}">
                            @csrf
                            <div class="form-group fill">
                                <label class="form-label" for="backup">Kondisi Backup</label>
                                <input type="text" class="form-control" id="backup"
                                    placeholder="{{ $title }}" name="backup" value="{{ old('backup') }}"
                                    required>
                                @error('backup')
