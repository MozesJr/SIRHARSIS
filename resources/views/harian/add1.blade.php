                                        ...
                                        <div class="row">
                                            <div class="alert alert-primary">
                                                <div class="media align-items-center">
                                                    ...
                                                    <div class="media-body ms-3"> Cara mengecek koneksi web service adalah
                                                        <br>
                                            ...
                                            <div class="col-md-6">
                                                <input class="form-control mb-3" type="file" name="image2"
                                                    accept="image/*" onchange="previewImage(this, 'preview2')" required>
                                        ...
                                        <div class="row">
                                            <div class="alert alert-primary">
                                                <div class="media align-items-center">
                                                    ...
                                                    <div class="media-body ms-3"> Cara mengecek free hardisk adalah dengan
                                        ...
                                        <div class="row">
                                            <div class="alert alert-primary">
                                                <div class="media align-items-center">
                                                    ...
                                                    <div class="media-body ms-3"> Cara mengecek Pengunjung adalah dengan
                                                        mengetik 'netstat -anp |grep tcp |grep ::ffff: |wc -l' pada cli di
                                                        server
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <input class="form-control mb-3" type="file" name="image6"
                                                    accept="image/*" onchange="previewImage(this, 'preview6')" required>
                                        ...
                                        <div class="row">
                                            <div class="alert alert-primary">
                                                <div class="media align-items-center">
                                                    ...
                                                    <div class="media-body ms-3"> Cara Mengecek bcakup aplikasi dengan cara
                                        ...
                                        <div class="row">
                                            <div class="alert alert-primary">
                                                <div class="media align-items-center">
                                                    ...
                                                    <div class="media-body ms-3"> Cara mengecek service DB adalah dengan
