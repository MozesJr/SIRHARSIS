...
@section('content')
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-12">
                            <div class="page-header-title">
                                <h5 class="m-b-10">Level Urgency</h5>
                            </div>
                            <ul class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{ route('dashboard') }}"><i
                                            class="feather icon-home"></i></a></li>
                                <li class="breadcrumb-item"><a href="#!">Level Urgency</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                                                ...
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th class="sorting" tabindex="0" aria-controls="simpletable"
                                                            rowspan="1" colspan="1"
                                                            aria-label="Level: activate to sort column ascending">Level</th>
                                                        <th class="sorting" tabindex="0" aria-controls="simpletable"
                                                            rowspan="1" colspan="1"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <button type="button" class="btn btn-warning"
                                                                    ...
                                                                    data-bs-target="#staticBackdrop1{{ $lvl->id }}">
                                                                    <i class="feather icon-settings"></i>
                                                                </button>
                                                                <div class="modal fade"
                                                                    id="staticBackdrop1{{ $lvl->id }}"
                                                                        ...
                                                                        <div class="modal-content">
                                                                            <div class="modal-header">
                                                                                <h5 class="modal-title"
                                                                                    id="staticBackdropLabel">Ubah Data Level
                                                                                    Urgency</h5>
                                                                            ...
                                                                            <div class="modal-body">
                                                                                <div class="col-md-12">
                                                                                    <form method="POST"
                                                                                        action="{{ route('level.update', $lvl->id) }}">
                                                                                        @csrf
                                                                                        @method('PUT')
                                                                                        <div class="form-group fill">
                                                                                            ...
                                                                                            <input type="text"
                                                                                                class="form-control"
                                                                                                id="level"
                                                                                                placeholder="Level Urgency"
                                                                                                name="level"
                                                                                                value="{{ old('level', $lvl->level) }}"
                                                                                                required>
                                                                                            @error('level')
    ...
    <div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="staticBackdropLabel">Tambah Data Level Urgency</h5>
                    ...
                    <div class="col-md-12">
                        <form method="POST" action="{{ route('level.store') }}">
                            ...
                            <div class="form-group fill">
                                ...
                                <input type="text" class="form-control" id="level" placeholder="Level Urgency"
