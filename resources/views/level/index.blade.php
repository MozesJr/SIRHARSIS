                                                                        ...
                                                                        <div class="modal-content">
                                                                            ...
                                                                            @else
                                                                                <div class="modal-body">
                                                                                    <div class="col-md-12">
                                                                                        <form method="POST"
                                                                                            action="{{ route('lvlSvr.update', $lvl->id) }}">
                                                                                            @csrf
                                                                                            @method('PUT')
                                                                                            <div class="form-group fill">
                                                                                                <label class="form-label"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="col-md-12">
                            <form method="POST" action="{{ route('level.store') }}">
                                @csrf
                                <div class="form-group fill">
                                    <label class="form-label" for="level">Level Urgency</label>
                                    <input type="text" class="form-control" id="level"
                                        placeholder="{{ $title }}" name="level" value="{{ old('level') }}"
                                        required>
                                    @error('level')
                ...
                @else
                    <div class="modal-body">
                        <div class="col-md-12">
                            <form method="POST" action="{{ route('lvlSvr.store') }}">
                                @csrf
                                <div class="form-group fill">
                                    <label class="form-label" for="level">Level Server</label>
                                    <input type="text" class="form-control" id="level"
                                        placeholder="{{ $title }}" name="level" value="{{ old('level') }}"
                                        required>
                                    @error('level')
