                    ...
                    <div class="card error-card">
                        <div class="card-body">
                            <div class="error-image-block">
                                <img class="img-fluid"
                                    src="https://ableproadmin.com/bootstrap/default/assets/images/pages/img-error-500.svg"
                                    alt="img">
                            </div>
                            <div class="text-center">
                                <h1 class="mt-4"><b>Internal Server Error</b></h1>
                                <p class="mt-2 mb-4 text-sm text-muted">Server error 500. we fixing the problem.
                                    please<br> try again at a later
                                    stage.</p>
